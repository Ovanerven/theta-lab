...
| CMVF-unb. | 0.606 | **0.080** | 0.055 | **0.012** |
| NODE-GRU | 0.776 | 0.103 | 0.083 | 0.020 |
| NODE-MLP | 0.729 | 0.116 | 0.181 | 0.319 |
| NODE-corr. | **0.424** | 0.083 | 0.177 | 0.305 |
...
| NODE-corr. | 3.0e6 | 2.4e5 | 1.0e5 | 1.3e4 |
| Global ($\theta$) | 0.019 | 0.014 | 0.014 | 0.007 |
| IC ($\theta$) | 0.009 | **0.002** | 0.003 | 0.004 |
...
| CMVF-unb. | 0.037 | **0.024** | 0.006 | 1.1e6 |
...
| IC ($\theta$) | 0.031 | 0.028 | 0.036 | 1.1e6 |
| **Enzyme/6** | | | | |
...
| NODE-corr. | 7.7e6 | 2.4e7 | 2.1e7 | 1.5e7 |
...
| NODE-corr. | 0.200 | 0.111 | 5.3e4 | 5.9e3 |
| Global ($\theta$) | 0.193 | 0.160 | 1.0e3 | 122.809 |
| IC ($\theta$) | 0.094 | 0.025 | **5.848** | 2.269 |
...
| CMVF-unb. | **0.735** | **0.424** | 23.357 | **3.835** |
| NODE-GRU | 1.989 | 3.658 | 8.8e5 | 1.6e7 |
| NODE-MLP | 0.871 | 3.890 | 2.9e7 | 1.2e7 |
| NODE-corr. | 0.979 | 0.865 | 2.9e5 | 1.2e5 |
...
| NODE-corr. | 0.328 | 0.309 | 1.1e4 | 4.7e5 |
...
| NODE-corr. | 0.295 | **0.100** | 0.125 | 0.137 |
...
| CMVF-unb. | 0.192 | **0.078** | **0.119** | **0.082** |
...
| CMVF-unb. | **0.215** | 0.266 | 0.172 | 0.088 |
...
| CMVF-unb. | 0.251 | 0.593 | **0.699** | 0.953 |
...
| IC ($\theta$) | **0.161** | 0.461 | 3.689 | 4.234 |
| **Glyc/12** | | | | |
| CMVF | 0.309 | 0.376 | 0.508 | 0.478 |
| CMVF-L1 | 0.307 | 0.323 | 0.449 | 9.4e6 |
| CMVF-unb. | **0.300** | 0.644 | 0.593 | **0.265** |
