...
# python last-layer-ode/train.py --config "configs/analytical_vs_rk4/reduced7.yaml"
# python last-layer-ode/train.py --config "configs/analytical_vs_rk4/reduced7_steps10.yaml"
python last-layer-ode/train.py --config "configs/analytical_vs_rk4/reduced7_analytical.yaml"
