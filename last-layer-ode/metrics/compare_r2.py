...
Usage:
    python last-layer-ode/metrics/compare_r2.py experiments/txtl_combined_sweep
    python last-layer-ode/metrics/compare_r2.py experiments/txtl_combined_sweep --csv results/r2.csv
    python last-layer-ode/metrics/compare_r2.py experiments/txtl_combined_sweep --plot
    python last-layer-ode/metrics/compare_r2.py experiments/txtl_combined_sweep --recompute
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("root", help="Study folder, e.g. experiments/txtl_combined_sweep")
