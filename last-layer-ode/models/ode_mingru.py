...
class OdeMinGRU(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        gru_init: str = "default",   # "orthogonal" -> xavier_(lin.weight)+zeros, on equal footing with GRU/LSTM/sLSTM
        ...
        **kwargs,
        ...
        # Recurrent init: "orthogonal" -> xavier on each minGRU cell's input projection
        ...
        # "supervisor" is a backward-compatible alias for "orthogonal".
        if str(gru_init) in ("orthogonal", "supervisor"):
