...
try:
    import cantera as ct  # optional: only the methane/combustion path needs it
except Exception:
    ct = None
...
try:  # methane/combustion models are not shipped in this repo
    from sim.explicit_methane_models import GRI30_FullModel, Kazakov_MiddleModel, Smooke_ReducedModel, Aramco_FullModel
except Exception:
    GRI30_FullModel = Kazakov_MiddleModel = Smooke_ReducedModel = Aramco_FullModel = None
...
MODEL_CONFIGS: Dict[str, ModelConfig] = {
    ...
    # Methane/combustion configs (gri30_full, kazakov_middle, smooke_reduced_model,
    # aramco_30) are omitted here — they build a Cantera gas object at import time
    # and Cantera is not a dependency of this repo.
